...
PAT_TEMPLATES = (
    ...
    "{user2} does an uno reverse card on {user1}",
    "yosh yosh!",
    "{user1} knocks out {user2} with chloroform and proceeds to headpat {user2}",
    "{user1} used YOU THOUGHT IT WAS HEADPATS BUT IT WAS ME BELLYRUB",
    "{user1} pats {user2} friendlily",
    "{user2} uses HEADPATS? O KAWAII KOTO",
    "headpats.gif intensifies",
    "(*´ω´(*｀ω｀)",
    "(ｏ・_・)ノ”(ᴗ_ ᴗ。)",
    "(*￣▽￣)ノ”(- -*)",
    "(っ´ω`)ﾉ(╥ω╥)",
