...
NEW_FED_HANDLER = DisableAbleCommandHandler("newfed", new_fed)
DEL_FED_HANDLER = DisableAbleCommandHandler("delfed", del_fed)
JOIN_FED_HANDLER = DisableAbleCommandHandler("joinfed", join_fed)
LEAVE_FED_HANDLER = CommandHandler("leavefed", leave_fed)
PROMOTE_FED_HANDLER = DisableAbleCommandHandler("fpromote", user_join_fed)
DEMOTE_FED_HANDLER = DisableAbleCommandHandler("fdemote", user_demote_fed)
INFO_FED_HANDLER = DisableAbleCommandHandler("fedinfo", fed_info)
BAN_FED_HANDLER = DisableAbleCommandHandler("fban", fed_ban)
UN_BAN_FED_HANDLER = DisableAbleCommandHandler("unfban", unfban)
FED_BROADCAST_HANDLER = CommandHandler("fbroadcast", fed_broadcast)
FED_SET_RULES_HANDLER = DisableAbleCommandHandler("setfrules", set_frules)
FED_GET_RULES_HANDLER = DisableAbleCommandHandler("frules", get_frules)
FED_CHAT_HANDLER = DisableAbleCommandHandler("chatfed", fed_chat)
FED_ADMIN_HANDLER = DisableAbleCommandHandler("fedadmins", fed_admin)
FED_USERBAN_HANDLER = DisableAbleCommandHandler("fbanlist", fed_ban_list)
FED_NOTIF_HANDLER = DisableAbleCommandHandler("fednotif", fed_notif)
