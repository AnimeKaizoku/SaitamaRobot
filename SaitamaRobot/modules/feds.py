  ...
  if is_user_fed_owner(fed_id, user.id) or user.id in SUDO_USERS:
    ...
    if user_id:
      ...
      user = msg.from_user
        ...
        not args or (len(args) >= 1 and not args[0].startswith("@") and
        ...
        for fedschat in all_fedschat:
          try:
            ...
            if excp.message in FBAN_ERRORS:
              ...
              LOGGER.warning("Unable to fban on {} because: {}".format(
    ...
    for chat in chat_list:
      ...
      try:
        ...
        try:
          ...
          LOGGER.info("Chat {} has left fed {} because I was punched".format(
              chat, fedinfo['fname']))
          continue
        failed += 1
    ...
    if fileformat == 'json':
      ...
      with BytesIO() as file:
        ...
        sql.multi_fban_user(multi_fed_id, multi_import_userid,
                            multi_import_firstname, multi_import_lastname,
