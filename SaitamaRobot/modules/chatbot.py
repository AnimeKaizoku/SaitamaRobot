...
def check_message(context: CallbackContext, message):
    ...
    if message.text.lower() == "zero two":
        return True
    if reply_msg:
...
__help__ = f"""
Chatbot utilizes Coffehouse API, allowing Zero Two to interact with users providing them more fun in the chat groups.
