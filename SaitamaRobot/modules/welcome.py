        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    "My master {first} has joined {chatname}, Show some respect!", reply_to_message_id=reply
                )
                welcome_log = (
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_text(
                    "Oiii!! A member of the Hero Association (Bot Developer) {first} has joined {chatname}",
                    reply_to_message_id=reply,
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
            ...
            # Welcome Sudos
                ...
                update.effective_message.reply_text(
                    "{first}, A Dragon admin has joined {chatname}! Bow down",
                    reply_to_message_id=reply,
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
            ...
            # Welcome Support
                ...
                update.effective_message.reply_text(
                    "Tch, Deal with Demon member {first} as he has joined {chatname}",
                    reply_to_message_id=reply,
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
            ...
            # Welcome Whitelisted
                ...
                update.effective_message.reply_text(
                    "An immortal tiger {first} has joined {chatname}", reply_to_message_id=reply
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
                    f"#USER_JOINED\n"
            ...
            # Welcome Tigers
                ...
                update.effective_message.reply_text(
                    "Behold the furious wolf! {first} has joined {chatname}", reply_to_message_id=reply
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
                    f"#USER_JOINED\n"
            ...
            # Welcome yourself
                ...
                if not SaitamaRobot.ALLOW_CHATS:
                    with suppress(BadRequest):
                         update.effective_message.reply_text(f"Groups are disabled for {bot.first_name}, I will be leaving.")
                ...
                update.effective_message.reply_text(
                    "Yes, How may I help you?", reply_to_message_id=reply
                )
                continue
    ...
    if should_goodbye:
        ...
        if left_mem:
            ...
            if left_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    "{mention} left the chat", reply_to_message_id=reply
                )
                return
...
def welcome(update: Update, context: CallbackContext):
    ...
    if not args or args[0].lower() == "noformat":
        ...
        if args[0].lower() in ("on", "yes"):
            ...
            update.effective_message.reply_text(
                "I will not welcome anyone then."
            )
...
def user_button(update: Update, context: CallbackContext):
    ...
    if join_user == user.id:
        ...
        query.answer(text="You're a human, unmuted!")
        bot.restrict_chat_member(
            chat.id,
            user.id,
            permissions=ChatPermissions(
