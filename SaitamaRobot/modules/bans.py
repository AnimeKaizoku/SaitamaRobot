...
def ban(update: Update, context: CallbackContext) -> str:
    ...
    if is_user_ban_protected(chat, user_id, member) and user not in DEV_USERS:
        if user_id == OWNER_ID:
            message.reply_text("User is protected against bans")
        elif user_id in DEV_USERS:
            message.reply_text("User is a developer.")
        elif user_id in DRAGONS:
            message.reply_text(
                "The authority can't be banned as they are essential for organization."
            )
            ...
            message.reply_text("Get permission from Managing Directors to ban the elite users!")
        else:
            message.reply_text("This user is an elite and cannot be banned.")
        return log_message
