...
A modular Telegram Python bot running on python3 with a sqlalchemy database and an entirely themed persona to make Karma suitable for Anime and Manga group chats. 
