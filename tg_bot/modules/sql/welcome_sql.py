...
DEFAULT_WELCOME_MESSAGES = [
    ...
    "Hi there {first}, Show me your Hunter License!",
    "Im looking for Garo, - oh wait, its {first}.",
    "Welcome {first}, Leaving is not an option!",
    "Run Forest! ..I mean...{first}.",
    "{first} do 100 push-ups, 100 sit-ups, 100 squats, and a 10km run EVERY SINGLE DAY!!!",
